...
class InspectionPDFController extends GetxController {
  ...
  void updateNearestBodyOfWater(String value) =>
      nearestBodyOfWater.value = value;
  ...
  void updatePrimaryConstruction(String value) =>
      primaryConstruction.value = value;
  ...
  void updateGuttersAndDownspout(String value) =>
      guttersAndDownspout.value = value;
  ...
  void updateWaterSpicketDamage(String value) =>
      waterSpicketDamage.value = value;
  ...
  void updateMissingShinglesTile(String value) =>
      missingShinglesTile.value = value;
  ...
  void updateBrokenOrCrackTiles(String value) =>
      brokenOrCrackTiles.value = value;
  ...
  void updateCarportConstruction(String value) =>
      carportConstruction.value = value;
  void updateFenceCondition(String value) => fenceCondition.value = value;

  // Dwelling Hazards Methods
  void updateBoardedDoorsWindows(String value) =>
      boardedDoorsWindows.value = value;
  void updateOvergrownVegetation(String value) =>
      overgrownVegetation.value = value;
  void updateAbandonedVehicles(String value) => abandonedVehicles.value = value;
  void updateMissingDamageSteps(String value) =>
      missingDamageSteps.value = value;
  void updateMissingDamageRailing(String value) =>
      missingDamageRailing.value = value;
  void updateDwellingSidingDamage(String value) =>
      dwellingSidingDamage.value = value;
  ...
  void updateChimneyThroughRoof(String value) =>
      chimneyThroughRoof.value = value;
  void updateFireplacePitOutside(String value) =>
      fireplacePitOutside.value = value;
  ...
  void updateDivingBoardOrSlide(String value) =>
      divingBoardOrSlide.value = value;
  ...
  void updateSkateboardOrBikeRamp(String value) =>
      skateboardOrBikeRamp.value = value;
  ...
  Future<void> generatePDF() async {
    try {
      ...
      final pdfBytes =
          await OptimizedInspectionPDFTemplate.generateInspectionReport(
      ...
      try {
        if (Platform.isAndroid) {
          ...
          if (!await saveDir.exists()) {
            print(
                '⚠️ [PDF] Download dir not found, using external storage dir.');
        ...
        final file = File(
            '${directory.path}/inspection_report_${DateTime.now().millisecondsSinceEpoch}.pdf');
        await file.writeAsBytes(pdfBytes);
        pdfPath.value = file.path;
  ...
  Future<void> openPDF() async {
    ...
    try {
      ...
      print(
          '📦 [PDF] OpenFile result: type=${result.type}, message=${result.message}');
      if (result.type == ResultType.done) {
        ...
        print(
            '❌ [PDF] Could not open PDF automatically. Showing share option.');
        Get.snackbar(
          'PDF Ready',
